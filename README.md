...
| --: | --- | --- | --- |
| 001 | [WiFi Scan](DOIT_ESP32_DEVKIT_V1_05_ESCANNER_WIFI_1n) | Escaneo de redes Wi-Fi cercanas desde una placa ESP32 DEVKIT V1 / ESP-WROOM-32, con salida tabulada en el Serial Monitor. | Funcional |
